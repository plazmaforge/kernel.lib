...
public interface YamlAppendable extends plazma.kernel.lib.ext.Appendable {
    
    public static final int DEFAULT_OBJECT_COLOR = COLOR_GREEN;               // "\x1b[92m";
    public static final int DEFAULT_ARRAY_COLOR = COLOR_LIGHT_BLUE;          // "\x1b[36m";
    ...
    public static final int DEFAULT_TEXT_COLOR = COLOR_LIGHT_BLUE; //COLOR_BLUE;                  // "\x1b[94m";
