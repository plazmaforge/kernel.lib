...
import plazma.lib.data.yaml.YamlLib;
import plazma.lib.data.yaml.YamlReaderConfig;
import plazma.lib.str.StrLib;
import plazma.lib.task.ConvertTask;
import plazma.lib.task.TaskContext;

public class Yaml2XmlConvertTask extends ConvertTask {
    
    public static final String TASK_CONVERT_YAML2XML  = "convert-yaml2xml";
