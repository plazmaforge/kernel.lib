#ifndef PLAZMA_KERNEL_LIB_TASK_XML_XML2YAML_CONVERT_TASK_H
#define PLAZMA_KERNEL_LIB_TASK_XML_XML2YAML_CONVERT_TASK_H
...
#endif // PLAZMA_KERNEL_LIB_TASK_XML_XML2YAML_CONVERT_TASK_H