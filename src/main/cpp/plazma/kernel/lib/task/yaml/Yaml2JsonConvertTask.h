#ifndef PLAZMA_KERNEL_LIB_TASK_YAML_YAML2JSON_CONVERT_TASK_H
#define PLAZMA_KERNEL_LIB_TASK_YAML_YAML2JSON_CONVERT_TASK_H
...
#endif // PLAZMA_KERNEL_LIB_TASK_YAML_YAML2JSON_CONVERT_TASK_H