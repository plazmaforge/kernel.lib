#ifndef PLAZMA_KERNEL_LIB_DATA_JSON_JSON_STRING_APPENDABLE_H
#define PLAZMA_KERNEL_LIB_DATA_JSON_JSON_STRING_APPENDABLE_H
...
#endif // PLAZMA_KERNEL_LIB_DATA_JSON_JSON_STRING_APPENDABLE_H