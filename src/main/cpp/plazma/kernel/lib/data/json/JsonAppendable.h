#ifndef PLAZMA_KERNEL_LIB_DATA_JSON_JSON_APPENDABLE_H
#define PLAZMA_KERNEL_LIB_DATA_JSON_JSON_APPENDABLE_H

#include <string>
#include "plazma/kernel/lib/ext/Appendable.h"
...
namespace json {
  ...
  const int DEFAULT_CDATA_COLOR = COLOR_ORANGE;               // "\x1b[33m";
    ...
    class JsonAppendable : public ext::Appendable {

        public:

          JsonAppendable();

          virtual ~JsonAppendable();
...
#endif // PLAZMA_KERNEL_LIB_DATA_JSON_JSON_APPENDABLE_H