#ifndef PLAZMA_LIB_TASK_JSON_JSON2XML_CONVERT_TASK_H
#define PLAZMA_LIB_TASK_JSON_JSON2XML_CONVERT_TASK_H
...
#endif // PLAZMA_LIB_TASK_JSON_JSON2XML_CONVERT_TASK_H