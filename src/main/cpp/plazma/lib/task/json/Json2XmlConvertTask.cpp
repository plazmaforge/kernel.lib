...
#include "plazma/lib/data/json/JsonReaderConfig.h"
...
namespace task {
    ...
    Json2XmlConvertTask::Json2XmlConvertTask() {}

    Json2XmlConvertTask::~Json2XmlConvertTask() {}

    void Json2XmlConvertTask::execute(TaskContext* ctx) {
    ...
    void Json2XmlConvertTask::initParameters() {
