#ifndef PLAZMA_KERNEL_LIB_TASK_TASK_PROVIDER_REGISTRY_H
#define PLAZMA_KERNEL_LIB_TASK_TASK_PROVIDER_REGISTRY_H
...
#endif // PLAZMA_KERNEL_LIB_TASK_TASK_PROVIDER_REGISTRY_H