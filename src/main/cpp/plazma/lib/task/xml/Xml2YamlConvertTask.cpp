...
namespace task {
    ...
    Xml2YamlConvertTask::Xml2YamlConvertTask() {}

    Xml2YamlConvertTask::~Xml2YamlConvertTask() {}

    void Xml2YamlConvertTask::execute(TaskContext* ctx) {
    ...
    void Xml2YamlConvertTask::initParameters() {
