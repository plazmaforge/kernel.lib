#ifndef PLAZMA_LIB_TASK_YAML_YAML2XML_CONVERT_TASK_H
#define PLAZMA_LIB_TASK_YAML_YAML2XML_CONVERT_TASK_H
...
#endif // PLAZMA_LIB_TASK_YAML_YAML2XML_CONVERT_TASK_H