...
namespace task {
    ...
    Yaml2JsonConvertTask::Yaml2JsonConvertTask() {}

    Yaml2JsonConvertTask::~Yaml2JsonConvertTask() {}

    void Yaml2JsonConvertTask::execute(TaskContext* ctx) {
    ...
    void Yaml2JsonConvertTask::initParameters() {
