...
#include "plazma/lib/task/sys/SysTask.h"
#include "plazma/lib/task/sys/CalendarTask.h"

#include "plazma/lib/task/xml/XmlFormatTask.h"
#include "plazma/lib/task/xml/Xml2JsonConvertTask.h"
#include "plazma/lib/task/xml/Xml2YamlConvertTask.h"

#include "plazma/lib/task/json/JsonFormatTask.h"
#include "plazma/lib/task/json/Json2XmlConvertTask.h"
#include "plazma/lib/task/json/Json2YamlConvertTask.h"

#include "plazma/lib/task/yaml/YamlFormatTask.h"
#include "plazma/lib/task/yaml/Yaml2XmlConvertTask.h"
#include "plazma/lib/task/yaml/Yaml2JsonConvertTask.h"

#include "plazma/lib/task/array/ArrayReadTask.h"
#include "plazma/lib/task/array/ArrayGenTask.h"

#include "plazma/lib/task/test/TestTask.h"
