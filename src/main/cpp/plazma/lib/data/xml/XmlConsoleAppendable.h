#ifndef PLAZMA_LIB_DATA_XML_XML_CONSOLE_APPENDABLE_H
#define PLAZMA_LIB_DATA_XML_XML_CONSOLE_APPENDABLE_H
...
#endif // PLAZMA_LIB_DATA_XML_XML_CONSOLE_APPENDABLE_H